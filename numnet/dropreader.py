...
@DatasetReader.register("drop_reader_for_numnet")
class DropReader(DatasetReader):
    ...
    def text_to_instance(self,  # type: ignore
        ...
        if self.instance_format == "squad":
            ...
            if all_number_rank is None:
                ...
                passage_number_rank = all_number_rank[:len(numbers_in_passage)]
                question_number_rank = all_number_rank[len(numbers_in_passage):]

            number_indices = [indice + 1 for indice in number_indices]
            numbers_in_passage.append(100)
            number_indices.append(0)
            passage_number_rank.append(-1)
            ...
            passage_number_rank = np.array(passage_number_rank)
    ...
    def make_marginal_drop_instance(question_tokens: List[Token],
                                    ...
                                    passage_number_rank: np.ndarray,
        ...
        fields["passage_number_rank"] = ArrayField(passage_number_rank, -1)
